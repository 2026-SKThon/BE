...
public class DailyRecordController {
    ...
    public ResponseEntity<BaseResponse<DailyRecordCursorResponse>> getAllDailyRecords(
            ...
            @Parameter(description = "커서 ID (이전 응답의 nextCursorId)") @RequestParam(required = false) Long cursorId,
        ...
        DailyRecordCursorResponse response = dailyRecordService
                .getAllDailyRecords(currentUserProvider.getCurrentUserId(), childId, size, cursorId, cursor);
